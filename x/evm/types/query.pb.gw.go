...
var (
	...
	pattern_Query_MappedEvmAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "evm", "v1", "mapped-evm-address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_MappedCosmosAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "evm", "v1", "mapped-cosmos-address"}, "", runtime.AssumeColonVerbOpt(false)))
